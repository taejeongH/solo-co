...
public class GroupTravelPromptBuilder {
    ...
    public String build(List<TravelProjectPlace> places, int tripDays) {
        ...
        return """
        사용자가 그룹 여행으로 방문할 예정인 장소 목록은 다음과 같다:
		...
		8) recommended_transport 필드는 절대 빈 문자열로 두지 말고, 해당하는 코스에 추천하는 교통 수단을 반드시 작성하라.
        ...
        2) creative_optimized
            ...
            - reason 필드에 새로운 장소를 포함한 이유를 명확히 작성한다.
        ...
        4) days[].places[] 안의 place 객체는 반드시 5개 필드를 모두 포함해야 한다.
        5) summary, recommended_transport는 절대 빈 값 금지
